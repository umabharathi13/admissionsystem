...
class ApplicationMockitoTest {
	...
	/**
	 * MockitoTestCase for the method adding the application to the database
	 */
	@Test
//	@Disabled
	void testAddApplication() {
		...
		ProgramScheduled psch = new ProgramScheduled(101, "2017-04-16", "2017-12-28", "Part time", pgm, course, b,
				university, col);
		Application a7 = new Application(6, "Arun", app1, "B.E", 75, "Engineer", "eve@gmail.com", "Rejected", app2,
				"Bad", psch);
	...
	/**
	 * MockitoTestCase for the method getting all the applicationDetails in the form
	 * of list
	 */
	@Test
//	@Disabled
	void testviewAllApplicationDetails() {
		...
		ProgramScheduled psch = new ProgramScheduled(101, "2017-04-16", "2017-12-28", "Part time", pgm, course, b,
				university, col);
		Application application = new Application(6, "Arun", app1, "B.E", 75, "Engineer", "eve@gmail.com", "Rejected",
				app2, "Bad", psch);
		...
		ProgramScheduled psch1 = new ProgramScheduled(102, "2017-04-16", "2017-12-28", "Part time", pgm1, course1, b1,
				university1, col1);
		Application application1 = new Application(9, "Arun", app3, "B.E", 75, "Engineer", "eve@gmail.com", "Rejected",
				app4, "Bad", psch1);
	...
	/**
	 * MockitoTestCase for the method getting the applicationDetails by using
	 * applicationId
	 */
	@Test
//	@Disabled
...
//	@Disabled
	...
	/**
	 * MockitoTestCase for the method updating applicationStatus
	 */
	@Test
//	@Disabled
	...
	/**
	 * MockitoTestCase for the method deleting the applicationDetails by using
	 * applicationId
	 */
	@Test
//	@Disabled
